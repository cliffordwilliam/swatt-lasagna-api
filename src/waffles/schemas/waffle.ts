...
export const WaffleCreateRequest = z.object({
    waffle_name: z.string().min(1, "Waffle name is required").max(100, "Waffle name is too long"),
});
export type WaffleCreateRequest = z.infer<typeof WaffleCreateRequest>;

export const WaffleUpdateRequest = z.object({
    waffle_name: z.string().min(1, "Waffle name is required").max(100, "Waffle name is too long").optional(),
});
